...
- **Lighthouse Score**: Aiming for 100/100 in Performance and Accessibility.
- **Bundle Size**: Minimized by avoiding heavy third-party dependencies.
- **HMR**: Sub-100ms hot module replacement for content and configuration changes.
